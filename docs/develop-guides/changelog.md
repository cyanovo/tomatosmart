...
- 新增草莓领域前端改造第一阶段：补充草莓沉浸式图片资产，新增“草莓驾驶舱”“生长档案”“成熟度管理中心”和“AI 日志”页面，将侧边栏入口调整为草莓业务导航，并把登录后默认入口切换到草莓驾驶舱；“智能工业物联网”升级为“智能温室物联网”路由命名。成熟度管理中心支持展示循迹小车扫描记录、成熟度状态、采摘建议，并在成熟度超过 80% 时展示可执行采摘小车入口。
