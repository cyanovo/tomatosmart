...
const rememberRemoteSource = (source) => {
  ...
  localStorage.setItem('greenhouse_remote_repo_history', JSON.stringify(history))
}
...
const loadHistory = () => {
  try {
    const raw = localStorage.getItem('greenhouse_remote_repo_history')
    if (raw) {
...
const deleteHistoryItem = (item) => {
  ...
  localStorage.setItem('greenhouse_remote_repo_history', JSON.stringify(repoHistory.value))
}

const clearAllHistory = () => {
  repoHistory.value = []
  localStorage.removeItem('greenhouse_remote_repo_history')
