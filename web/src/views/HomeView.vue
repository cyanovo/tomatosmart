          ...
          <aside class="hero-visual reveal-up delay-1">
            <div class="visual-card">
              ...
              <div class="flow-diagram">
                <div class="flow-row">
                  <div class="flow-node">
                    <span class="flow-icon"><ScanLine :size="20" /></span>
                    <span class="flow-name">循迹扫描</span>
                  </div>

                  <div class="flow-link" aria-hidden="true">
                    <span class="flow-rail"></span>
                    <span class="flow-dot flow-dot--fwd" :style="{ '--i': 0 }"></span>
                    <span class="flow-dot flow-dot--fwd" :style="{ '--i': 1 }"></span>
                  </div>
                  ...
                  <div class="flow-node flow-node--hub">
                    ...
                    <span class="flow-name">成熟度识别</span>
                  </div>
                  ...
                  <div class="flow-node">
                    <span class="flow-icon"><Truck :size="20" /></span>
                    <span class="flow-name">采摘派发</span>
                  </div>
                  ...
                  <div class="flow-node">
                    <span class="flow-icon"><ShieldCheck :size="20" /></span>
                    <span class="flow-name">品质分级</span>
                  </div>
                </div>

                <p class="flow-caption">循迹小车自动扫描 · AI 识别成熟度 · 精准派发采摘 · 品质自动分级</p>
              </div>
